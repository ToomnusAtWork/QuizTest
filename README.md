# PHP Quiz test with and without framework

This repository is dedicating to create dependent dropdown or dynamic dropdown base on data on sqlite which is useful for the address selection. This repo will have pure php method and the using framework solution one. For laravel method please switch to laravel branch.
